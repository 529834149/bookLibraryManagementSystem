        ...
        <div class="form-box">
            ...
            <div class="wrap">
                <form class="layui-form"> <!-- 提示：如果你不想用form，你可以换成div等任何一个普通元素 -->
                  ...
                  <div class="layui-form-item">
                    <div class="layui-input-block">
                      <input type="text" name="password" lay-verify="required|password" id="password" placeholder="请输入8到16位数字与密码组合的密码" autocomplete="off" class="layui-input">
                    </div>
                  </div>
                  <!-- 确认密码 -->
                  <div class="layui-form-item">
                    <div class="layui-input-block">
                      <input type="text" name="q_password" lay-verify="required|q_password" id="q_password" placeholder="请输入8到16位数字与密码组合的确认密码" autocomplete="off" class="layui-input">
                    </div>
                  </div>
                  <!-- <div class="layui-form-item">
                    <div class="layui-input-block">
                  ...
                  <input type="hidden" name="sendCode_key" id="sendCode_key" value="">
                  ...
                  <div class="layui-form-item">
                    <div class="layui-input-block">
                      ...
                      <button lay-submit lay-filter="login" class="layui-btn">去注册</button>
                    </div>
                  </div>
